...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!id || !passwordValue) {
      toast.error('Please enter both admission ID and password');
      return;
    }
    ...
    try {
      ...
      if (id === '7975035' && passwordValue === '1234') {
              ...
              <div className="space-y-2 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="bg-[#0a2e0a]/50 border-accent/30 text-[#d4f4dd] placeholder:text-[#d4f4dd]/40 focus:border-accent focus:ring-accent/50 transition-all duration-300 h-12 pr-10"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#d4f4dd]/60 hover:text-[#d4f4dd] transition-colors"
